...
class deepcam(tf.keras.Model):
    """DeepCAM network architecture provider tf.keras.Model implementation.
    Args:
        num_classes:
    ...
    def build(self, input_shape):
        ...
        self.input_b_conv = deepcam._get_conv_block(48,
                                                          kernel_size=(1, 1))

        self.conv1 = deepcam._get_conv_block(256, kernel_size=3,
                                                   conv_activation='relu')

        self.conv2 = deepcam._get_conv_block(256, kernel_size=3,
                                                   conv_activation='relu')
...
"""Module providing building blocks for the DeepCAM netowork architecture.
"""
...
class ConvBlock(tf.keras.layers.Layer):
    """Convolutional Block for DeepCAM
...
class AtrousSpatialPyramidPooling(tf.keras.layers.Layer):
    """Atrous Spatial Pyramid Pooling layer for DeepCAM architecture."""
